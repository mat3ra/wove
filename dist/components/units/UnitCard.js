...
export function UnitCard({ index, unit, actions = [], isSelected = false, isBorder = true, onSelect = () => undefined, animateOnHover = false, isCardContentExpanded = true, showDeveloperInfo = false, showStatus = true, }) {
    var _a, _b, _c;
    const onCardClick = (e) => {
