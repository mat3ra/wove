...
const paletteMain = (theme, color) => { var _a; return ((_a = theme.palette[color]) === null || _a === void 0 ? void 0 : _a.main) || theme.palette.grey[600]; };
...
export const StyledBadge = styled(Badge, {
    ...
    "& .MuiBadge-badge": {
        backgroundColor: paletteMain(theme, color),
